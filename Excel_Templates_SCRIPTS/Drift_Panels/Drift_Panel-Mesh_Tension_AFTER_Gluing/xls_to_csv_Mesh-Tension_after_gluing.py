...
workbook =  xlrd.open_workbook('DRIFT_PANEL–MESH_TENSION_AFTER_GLUING_TEST.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('DRIFT_PANEL–MESH_TENSION_AFTER_GLUING_TEST.csv', 'wb')
"""
...
resstr+=";".join(["",str(EQID),'MESH_TENS_AG_MIN_DT',str(sheet.cell(22,7).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'MESH_TENS_AG_MAX_DT',str(sheet.cell(22,9).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'MESH_TENS_AG_AVG_DT',str(sheet.cell(22,11).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'MESH_TENS_AG_RMS_DT',str(sheet.cell(22,13).value),"","T",'skfh_1',fdate,shifter,'ggiakous'])
