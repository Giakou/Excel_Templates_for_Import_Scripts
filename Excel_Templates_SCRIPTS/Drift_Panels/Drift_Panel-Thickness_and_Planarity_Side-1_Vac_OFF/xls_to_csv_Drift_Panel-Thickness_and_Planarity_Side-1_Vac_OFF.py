...
workbook =  xlrd.open_workbook('/home/atlas-auth/Programs/ATLAS_NSW_AUTH_IMPORT_SCRIPTS/Excel_Measurements_Playground/Drift_Panels/Drift_Panel-Thickness_and_Planarity_Side-1_Vac_OFF/Drift_Panel-Thickness_and_Planarity_Side-1_Vac_OFF.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('/home/atlas-auth/Programs/ATLAS_NSW_AUTH_IMPORT_SCRIPTS/CSV_files_Playground/Drift_Panels/Drift_Panel-Thickness_and_Planarity_Side-1_Vac_OFF/Drift_Panel-Thickness_and_Planarity_Side-1_Vac_OFF.csv', 'wb')
...
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_SIDE_1_MIN',str(sheet.cell(32,2).value),"","T","",fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position]) +"\n"
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_SIDE_1_MAX',str(sheet.cell(32,4).value),"","T","",fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position]) +"\n"
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_SIDE_1_AVG',str(sheet.cell(32,6).value),"","T","",fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position]) +"\n"
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_SIDE_1_RMS',str(sheet.cell(32,8).value),"","T","",fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position])
