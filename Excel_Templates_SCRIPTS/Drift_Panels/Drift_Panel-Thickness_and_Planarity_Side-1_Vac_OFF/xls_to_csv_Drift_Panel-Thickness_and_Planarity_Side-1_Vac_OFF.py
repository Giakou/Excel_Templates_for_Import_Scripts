...
workbook =  xlrd.open_workbook('Drift_Panel-Thickness_and_Planarity_Side-1_Vac_OFF.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('Drift_Panel-Thickness_and_Planarity_Side-1_Vac_OFF.csv', 'wb')
"""
...
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_SIDE_1_MIN',str(sheet.cell(40,0).value),"","T","",fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_SIDE_1_MAX',str(sheet.cell(40,2).value),"","T","",fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_SIDE_1_AVG',str(sheet.cell(40,4).value),"","T","",fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_SIDE_1_RMS',str(sheet.cell(40,6).value),"","T","",fdate,shifter,'ggiakous'])
