...
workbook =  xlrd.open_workbook('/home/atlas-auth/Programs/ATLAS_NSW_AUTH_IMPORT_SCRIPTS/Excel_Measurements_Playground/Outer_Layer_Boards/Outer_Layer_Boards-Thickness_after_manufacturing_on_perimeter_only/Outer_Layer_Boards-Thickness_after_manufacturing_on_perimeter_only.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('/home/atlas-auth/Programs/ATLAS_NSW_AUTH_IMPORT_SCRIPTS/CSV_files_Playground/Outer_Layer_Boards/Outer_Layer_Boards-Thickness_after_manufacturing_on_perimeter_only/Outer_Layer_Boards-Thickness_after_manufacturing_on_perimeter_only.csv', 'wb')
