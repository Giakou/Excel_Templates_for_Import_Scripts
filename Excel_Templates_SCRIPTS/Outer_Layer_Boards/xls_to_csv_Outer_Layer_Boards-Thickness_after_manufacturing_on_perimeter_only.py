...
workbook =  xlrd.open_workbook('Outer_Layer_Boards-Thickness_after_manufacturing_on_perimeter_only.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('Outer_Layer_Boards-Thickness_after_manufacturing_on_perimeter_only.csv', 'wb')
"""
...
resstr+=";".join(["",str(EQID),'OLB_THICK_MIN_DT',str(sheet.cell(20,1).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'OLB_THICK_MAX_DT',str(sheet.cell(20,3).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'OLB_THICK_AVG_DT',str(sheet.cell(20,5).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'OLB_THICK_RMS_DT',str(sheet.cell(20,7).value),"","T",'skfh_1',fdate,shifter,'ggiakous'])
