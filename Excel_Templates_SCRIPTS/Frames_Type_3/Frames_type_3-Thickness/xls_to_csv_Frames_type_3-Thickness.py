...
workbook =  xlrd.open_workbook('Frames_type_3-Thickness.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('Frames_type_3-Thickness.csv', 'wb')
"""
...
resstr+=";".join(["",str(EQID),'FR_TYPE_3_THICK_MIN_DT',str(sheet.cell(33,1).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'FR_TYPE_3_THICK_MAX_DT',str(sheet.cell(33,3).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'FR_TYPE_3_THICK_AVG_DT',str(sheet.cell(33,5).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'FR_TYPE_3_THICK_RMS_DT',str(sheet.cell(33,7).value),"","T",'skfh_1',fdate,shifter,'ggiakous'])
