...
workbook =  xlrd.open_workbook('External_panel_planarity_and_thickness_measurements.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('External_panel_planarity_and_thickness_measurements.csv', 'wb')
"""
...
"""
#############################################################
shifter=sheet.cell(5,4).value
EQID=int(sheet.cell(5,0).value)
date=sheet.cell(5,2).value
...
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_MIN',str(sheet.cell(29,0).value),"","T","",fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_MAX',str(sheet.cell(29,2).value),"","T","",fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_AVG',str(sheet.cell(29,4).value),"","T","",fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'DT_PAN_PLAN_RMS',str(sheet.cell(29,6).value),"","T","",fdate,shifter,'ggiakous'])
