...
workbook =  xlrd.open_workbook('/home/atlas-auth/Programs/ATLAS_NSW_AUTH_IMPORT_SCRIPTS/Excel_Measurements_Playground/Honeycomb/Honeycomb-Thickness_of_pieces_after_cutting/Honeycomb-Thickness_of_pieces_after_cutting.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('/home/atlas-auth/Programs/ATLAS_NSW_AUTH_IMPORT_SCRIPTS/CSV_files_Playground/Honeycomb/Honeycomb-Thickness_of_pieces_after_cutting/Honeycomb-Thickness_of_pieces_after_cutting.csv', 'wb')
...
resstr+=";".join(["",str(EQID),'HC_THICK_MIN',str(sheet.cell(12,3).value),"","T","",fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position]) +"\n"
resstr+=";".join(["",str(EQID),'HC_THICK_MAX',str(sheet.cell(12,5).value),"","T","",fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position]) +"\n"
resstr+=";".join(["",str(EQID),'HC_THICK_AVG',str(sheet.cell(12,7).value),"","T","",fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position]) +"\n"
resstr+=";".join(["",str(EQID),'HC_THICK_RMS',str(sheet.cell(12,9).value),"","T","",fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position])
