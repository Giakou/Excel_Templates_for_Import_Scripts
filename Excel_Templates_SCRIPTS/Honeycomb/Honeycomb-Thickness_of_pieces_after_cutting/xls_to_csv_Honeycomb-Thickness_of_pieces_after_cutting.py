...
workbook =  xlrd.open_workbook('Honeycomb-Thickness_of_pieces_after_cutting.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('Honeycomb-Thickness_of_pieces_after_cutting.csv', 'wb')
"""
...
resstr+=";".join(["",str(EQID),'HC_THICK_MIN',str(sheet.cell(20,0).value),"","T","",fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'HC_THICK_MAX',str(sheet.cell(20,2).value),"","T","",fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'HC_THICK_AVG',str(sheet.cell(20,4).value),"","T","",fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'HC_THICK_RMS',str(sheet.cell(20,6).value),"","T","",fdate,shifter,'ggiakous'])
