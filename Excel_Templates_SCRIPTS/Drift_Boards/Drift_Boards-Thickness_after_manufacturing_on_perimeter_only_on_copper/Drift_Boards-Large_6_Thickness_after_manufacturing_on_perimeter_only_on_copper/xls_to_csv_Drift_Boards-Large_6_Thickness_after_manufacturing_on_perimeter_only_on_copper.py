...
workbook =  xlrd.open_workbook('/home/atlas-auth/Programs/ATLAS_NSW_AUTH_IMPORT_SCRIPTS/Excel_Measurements_Playground/Drift_Boards/Drift_Boards-Thickness_after_manufacturing_on_perimeter_only_on_copper/Drift_Boards-Large_6_Thickness_after_manufacturing_on_perimeter_only_on_copper/Drift_Boards-Large_6_Thickness_after_manufacturing_on_perimeter_only_on_copper.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('/home/atlas-auth/Programs/ATLAS_NSW_AUTH_IMPORT_SCRIPTS/CSV_files_Playground/Drift_Boards/Drift_Boards-Thickness_after_manufacturing_on_perimeter_only_on_copper/Drift_Boards-Large_6_Thickness_after_manufacturing_on_perimeter_only_on_copper/Drift_Boards-Large_6_Thickness_after_manufacturing_on_perimeter_only_on_copper.csv', 'wb')
...
resstr+=";".join(["",str(EQID),'DB_THICK_ON_COP_MIN_DT',str(sheet.cell(21,2).value),"","T",'skfh_1',fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position]) +"\n"
resstr+=";".join(["",str(EQID),'DB_THICK_ON_COP_MAX_DT',str(sheet.cell(21,4).value),"","T",'skfh_1',fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position]) +"\n"
resstr+=";".join(["",str(EQID),'DB_THICK_ON_COP_AVG_DT',str(sheet.cell(21,6).value),"","T",'skfh_1',fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position]) +"\n"
resstr+=";".join(["",str(EQID),'DB_THICK_ON_COP_RMS_DT',str(sheet.cell(21,8).value),"","T",'skfh_1',fdate,shifter,'ggiakous',meascomment,meascommenttype,eqcomment,eqcommenttype,position])
