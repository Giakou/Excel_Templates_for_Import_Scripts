...
workbook =  xlrd.open_workbook('Drift_Boards-Large_8_Thickness_after_manufacturing_on_perimeter_only_on_copper.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('Drift_Boards-Large_8_Thickness_after_manufacturing_on_perimeter_only_on_copper.csv', 'wb')
"""
