...
workbook =  xlrd.open_workbook('Drift_Boards-Large_7_Thickness_after_manufacturing_on_perimeter_only_on_copper.xls')
sheet = workbook.sheet_by_name('Sheet1')
csvfile = open('Drift_Boards-Large_7_Thickness_after_manufacturing_on_perimeter_only_on_copper.csv', 'wb')
"""
...
resstr+=";".join(["",str(EQID),'DB_THICK_ON_COP_MIN_DT',str(sheet.cell(20,1).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'DB_THICK_ON_COP_MAX_DT',str(sheet.cell(20,3).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'DB_THICK_ON_COP_AVG_DT',str(sheet.cell(20,5).value),"","T",'skfh_1',fdate,shifter,'ggiakous']) +"\n"
resstr+=";".join(["",str(EQID),'DB_THICK_ON_COP_RMS_DT',str(sheet.cell(20,7).value),"","T",'skfh_1',fdate,shifter,'ggiakous'])
